...
tstart = '25-feb-2014 00:40:00'						; start time selection
tend   = '25-feb-2014 00:50:00'						; end time selection

path = '~/SDO_data/25-feb-2014'					; data storage folder path
...
result = obj -> desaturation( wav , tstart , tend  , path , $
  /save_fts , /aec, /loud, /onewindow, lev=1.0, dwavelength=0.005 , path_save = '../../' )
