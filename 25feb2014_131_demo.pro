...
tend   = '25-feb-2014 00:45:30'						; end time selection

path = '~/SDO_data/20140225_1000'						; data storage folder path
...
result = obj -> desaturation( wav , tstart , tend  , path , $
  /save_fts , /aec, /loud, /onewindow, lev=1.0, dwavelength=0.00 , path_save = '../../' )
